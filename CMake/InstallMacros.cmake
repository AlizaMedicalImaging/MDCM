macro(install_library library)
  if(NOT MDCM_INSTALL_NO_LIBRARIES)
    install(TARGETS ${library}
      ...
      LIBRARY DESTINATION ${MDCM_INSTALL_LIBDIR} COMPONENT Libraries ${NAMELINK_SKIP}
      INCLUDES DESTINATION ${MDCM_INSTALL_INCLUDE_DIR}
      ARCHIVE DESTINATION ${MDCM_INSTALL_LIBDIR} COMPONENT DebugDevel)
    if(NAMELINK_ONLY)
      install(TARGETS ${library}
        EXPORT ${MDCM_TARGETS_NAME}
        LIBRARY DESTINATION ${MDCM_INSTALL_LIBDIR} COMPONENT DebugDevel ${NAMELINK_ONLY})
    endif()
  endif()
endmacro()
