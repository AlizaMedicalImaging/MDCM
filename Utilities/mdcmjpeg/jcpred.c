...
METHODDEF(void) start_pass JPP((j_compress_ptr cinfo));
...
METHODDEF(void)
jpeg_difference1(j_compress_ptr cinfo,
                 int            ci,
                 JSAMPROW       input_buf,
                 JSAMPROW       prev_row,
                 JDIFFROW       diff_buf,
...
METHODDEF(void)
jpeg_difference2(j_compress_ptr cinfo,
                 int            ci,
                 JSAMPROW       input_buf,
                 JSAMPROW       prev_row,
                 JDIFFROW       diff_buf,
...
METHODDEF(void)
jpeg_difference3(j_compress_ptr cinfo,
                 int            ci,
                 JSAMPROW       input_buf,
                 JSAMPROW       prev_row,
                 JDIFFROW       diff_buf,
...
METHODDEF(void)
jpeg_difference4(j_compress_ptr cinfo,
                 int            ci,
                 JSAMPROW       input_buf,
                 JSAMPROW       prev_row,
                 JDIFFROW       diff_buf,
...
METHODDEF(void)
jpeg_difference5(j_compress_ptr cinfo,
                 int            ci,
                 JSAMPROW       input_buf,
                 JSAMPROW       prev_row,
                 JDIFFROW       diff_buf,
...
METHODDEF(void)
jpeg_difference6(j_compress_ptr cinfo,
                 int            ci,
                 JSAMPROW       input_buf,
                 JSAMPROW       prev_row,
                 JDIFFROW       diff_buf,
...
METHODDEF(void)
jpeg_difference7(j_compress_ptr cinfo,
                 int            ci,
                 JSAMPROW       input_buf,
                 JSAMPROW       prev_row,
                 JDIFFROW       diff_buf,
...
METHODDEF(void)
jpeg_difference_first_row(j_compress_ptr cinfo,
                          int            ci,
                          JSAMPROW       input_buf,
                          JSAMPROW       prev_row,
                          JDIFFROW       diff_buf,
...
jinit_differencer(j_compress_ptr cinfo)
{
  ...
  pred = (c_pred_ptr)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE, SIZEOF(c_predictor));
