...
build_ycc_rgb_table(j_decompress_ptr cinfo)
{
  ...
  cconvert->Cb_b_tab =
    (int *)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE, (MAXJSAMPLE + 1) * SIZEOF(int));
  cconvert->Cr_g_tab =
    (IJG_INT *)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE, (MAXJSAMPLE + 1) * SIZEOF(IJG_INT));
  cconvert->Cb_g_tab =
    (IJG_INT *)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE, (MAXJSAMPLE + 1) * SIZEOF(IJG_INT));
...
ycc_rgb_convert(j_decompress_ptr cinfo, JSAMPIMAGE input_buf, JDIMENSION input_row, JSAMPARRAY output_buf, int num_rows)
{
  ...
  register IJG_INT * Crgtab = cconvert->Cr_g_tab;
  register IJG_INT * Cbgtab = cconvert->Cb_g_tab;
  SHIFT_TEMPS
