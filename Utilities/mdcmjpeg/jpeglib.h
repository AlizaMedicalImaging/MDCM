...
#ifdef NEED_DARRAY
  JMETHOD(JDIFFARRAY, alloc_darray, (j_common_ptr cinfo, int pool_id, JDIMENSION diffsperrow, JDIMENSION numrows));
#endif
...
EXTERN(void) jpeg_simple_lossless JPP((j_compress_ptr cinfo, int predictor, int point_transform));
