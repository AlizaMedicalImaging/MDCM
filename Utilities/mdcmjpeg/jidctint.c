 ...
 * intermediate IJG_INT array would be needed.)
 *
...
#  if CONST_BITS == 13
#    define FIX_0_298631336 ((IJG_INT)2446)  /* FIX(0.298631336) */
#    define FIX_0_390180644 ((IJG_INT)3196)  /* FIX(0.390180644) */
#    define FIX_0_541196100 ((IJG_INT)4433)  /* FIX(0.541196100) */
#    define FIX_0_765366865 ((IJG_INT)6270)  /* FIX(0.765366865) */
#    define FIX_0_899976223 ((IJG_INT)7373)  /* FIX(0.899976223) */
#    define FIX_1_175875602 ((IJG_INT)9633)  /* FIX(1.175875602) */
#    define FIX_1_501321110 ((IJG_INT)12299) /* FIX(1.501321110) */
#    define FIX_1_847759065 ((IJG_INT)15137) /* FIX(1.847759065) */
#    define FIX_1_961570560 ((IJG_INT)16069) /* FIX(1.961570560) */
#    define FIX_2_053119869 ((IJG_INT)16819) /* FIX(2.053119869) */
#    define FIX_2_562915447 ((IJG_INT)20995) /* FIX(2.562915447) */
#    define FIX_3_072711026 ((IJG_INT)25172) /* FIX(3.072711026) */
#  else
...
#  ifndef NO_ZERO_ROW_TEST
    ...
    {
      /* AC terms all zero */
      JSAMPLE dcval = range_limit[(int)DESCALE((IJG_INT)wsptr[0], PASS1_BITS + 3) & RANGE_MASK];
...
#  endif
    ...
    tmp0 = (IJG_INT)wsptr[7];
    tmp1 = (IJG_INT)wsptr[5];
    tmp2 = (IJG_INT)wsptr[3];
    tmp3 = (IJG_INT)wsptr[1];
