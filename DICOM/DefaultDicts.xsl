...
<!-- share common code to transform a VM Part 6 string into a mdcm::VM type
-->
<!--
...
#ifndef MDCMDEFAULTDICTS_CXX
#define MDCMDEFAULTDICTS_CXX
...
<!--
Note: We need to produce generic group length for all known groups but 0000 and 0002 since they have there own already
